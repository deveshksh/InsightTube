...
#     def run(self):
#         st.set_page_config(page_title="InsightTube", page_icon="chart_with_upwards_trend", layout="wide")
...
class AIVideoSummarizer:
    ...
    def run(self):
        ...
        # HTML/CSS styling for the title
        title_html = f"""
        <div style="font-family: 'Roboto', sans-serif; font-size: 72px; font-weight: bold;">
            <span style="color: red;">I</span><span style="color: white;">nsight<span style="color: red;">T<span style="color: white;">ube</span>
        </div>
        """
